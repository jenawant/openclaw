...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    ...
    users: "Gerencie contas locais, funções e vínculos de agente por usuário.",
    onboarding: "Execute o assistente de configuracao para onboarding visual do gateway.",
