...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    users: "Lokale Konten, Rollen und benutzerspezifische Agent-Bindungen verwalten.",
    onboarding: "Den Setup-Assistenten fuer die visuelle Gateway-Einrichtung ausfuehren.",
